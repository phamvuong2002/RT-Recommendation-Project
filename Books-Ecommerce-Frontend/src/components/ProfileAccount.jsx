    ...
    return (
        <div className="flex flex-col xl:w-2/3 overflow-y-auto h-full font-inter">
            <div className="flex flex-col xl:flex-row w-full gap-1 font-inter bg-white">
                <div className="font-semibold py-2 text-red-500 w-full px-2 xl:hidden">Thông Tin Tài Khoản</div>
            </div>
            {
                reloadUserData ? < TextLoader items={4} /> :
                    <div className="flex flex-col gap-2">
                        <div className="flex flex-col mt-2">
                            ...
                            {/* Bookada ID */}
                            <div className="flex xl:gap-2 justify-between text-sm bg-white h-12 px-2 cursor-pointer border-b border-gray-200" onClick={() => handleCopyId(userData.userid)}>
                                <label className="flex items-center" htmlFor="Bookada ID">Bookada ID</label>
                                <div className="flex items-center gap-2 text-gray-400">
                                ...
                                <PopupCenterPanel
                                    ...
                                    content={popupContent('text-gray-800 text-base text-center',
                                        <div className="flex flex-col gap-2 justify-center items-center">
                                            ...
                                            <div>
                                                {`BookadaID đã được sao chép thành công!`}
                                            </div>
                                        </div>
                                    )}
                                />
                            ...
                            {/*Password*/}
                            <div className="flex xl:gap-2 justify-between text-sm bg-white h-12 px-2 border-b border-gray-200" onClick={handleChangePassword}>
                                <label className="flex items-center" htmlFor="Thay Đổi Mật Khẩu">Thay Đổi Mật Khẩu</label>
                                <div className="flex items-center gap-2 text-gray-400">
                        ...
                        <div className="flex flex-col">
                            {/*Email*/}
                            <div className="flex xl:gap-2 justify-between text-sm bg-white h-12 px-2 border-b border-gray-200"
                            ...
                            <div className="flex xl:gap-2 justify-between text-sm bg-white h-12 px-2 border-b border-gray-200"
                                ...
                                <label className="flex items-center" htmlFor="Thay Đổi Số Điện Thoại">Thay Đổi Số Điện Thoại</label>
                                <div className="flex items-center gap-2 text-gray-400">
                            ...
                            <div className="flex xl:gap-2 justify-between text-sm bg-white h-12 px-2 border-b border-gray-200" onClick={handleChangeSex}>
                                <label className="flex items-center" htmlFor="Giới Tính">Giới Tính</label>
                                <div className="flex items-center gap-2 text-gray-400">
                                    <div>{userData.sex === "male" ? "Nam" : userData.sex === "female" ? "Nữ" : "Khác"}</div>
                                    <ChangeSexPopup
                            ...
                            {/* Ngày Sinh */}
                            <div className="flex xl:gap-2 justify-between text-sm bg-white h-12 px-2 border-b border-gray-200" onClick={handleChangeBirthday}>
                                <label className="flex items-center" htmlFor="Ngày Sinh">Ngày Sinh</label>
                                <div className="flex items-center gap-2 text-gray-400">
