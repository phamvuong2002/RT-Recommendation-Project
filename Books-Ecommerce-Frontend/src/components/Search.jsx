    ...
    return (
        <div id="search-bar" className="h-0.8 sm:my-3 bg-gray-100 rounded-[5px] grid">
            <div className="relative flex items-stretch">
                <input
                    className="w-full relative m-0 block flex-auto  border-neutral-300 bg-gray-100 bg-clip-padding px-3 py-[0.1rem] text-xs sm:text-base lg:text-lg font-normal  text-neutral-700 outline-none transition duration-200 ease-in-out focus:z-[3]  focus:outline-none "
