    ...
    return (
        <div className="p-2">
            ...
            <div className="justify-between bg-white px-2 py-1 shadow-md shadow-red-100 sm:flex sm:justify-start font-inter">
                {/* Product Image */}
                <img loading='lazy' src={product.imageSrc} alt={product.imageAlt} className="w-full rounded-lg sm:w-40" />
                ...
                <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between xl:flex xl:gap-8">
                    ...
                    <div className="flex flex-col xl:gap-2 mt-2 sm:mt-0">
                        ...
                        <div>
                            ...
                            <p className="mt-1 xl:mt-0 text-[0.6rem] xl:text-[0.7rem] text-red-500">Còn lại: {product.quantity} sản phẩm</p>
                        </div>
                    </div>
                            ...
                            <div className="xl:flex md:flex md:gap-4 xl:gap-2 items-end justify-center hidden">
                                <div className="flex">
                                    <PopupCenterPanel
                                        ...
                                        icon={
                                            <button className="xl:h-8 xl:w-8 xl:flex xl:items-end" onClick={() => handleClickAddLoveProduct(product.id)}>
