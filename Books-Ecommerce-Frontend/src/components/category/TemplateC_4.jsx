...
export const TemplateC_4 = ({ categoryData }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative xl:inline-block w-full h-full hidden">
        <img
          src="./img/category_template/template_1_1.png"
          alt=""
          className="absolute inset-0 z-10 w-full h-[85.8%] rounded-bl-md rounded-br-md"
        />
        {/* Book Images */}
        <div className="relative z-10 flex flex-col top-16 right-[0.5rem] gap-4 justify-center items-center w-[50%]">
          <div className="flex gap-1 pt-1 pl-6">
            <img
              src={category?.images[0]}
              alt="image1"
              className="w-14 h-20 rounded-sm"
            />
          </div>
      ...
      <div className="xl:hidden flex flex-col">
        <div>
          <img
            ...
            src="./img/category_template/template_1_1_mb.png"
            alt={category?.category?.[category?.category.length - 1]?.cateName}
          />
          {/* Book Images */}
          <div className="fixed z-10 flex flex-col top-1 gap-[0.1rem] left-1 justify-center items-center w-[50%]">
            <div className="flex">
              <img
                src={category?.images[0]}
                alt="image1"
