...
export const sharePopupUI = (url) => {
    const shareOnFacebook = () => {
        window.open(`https://www.facebook.com/sharer/sharer.php?u=${url}`, 'facebook-share-dialog', 'width=626,height=436');
    };

    const shareOnTwitter = () => {
        const text = encodeURIComponent('Chia sẻ sách từ Bookada');
    ...
    const shareOnTelegram = () => {
        const text = encodeURIComponent('Your Telegram message');
    ...
    return (
        <div className="font-inter">
            <div className="my-4">
                <p className="text-sm">Chia sẻ qua mạng xã hội</p>
                ...
                <p className="text-sm">Hoặc sử dụng link</p>
                ...
                <div className="border-2 border-gray-200 flex justify-between items-center mt-4 py-2">
                    ...
                    <input className="w-full ml-1 mr-4 outline-none bg-transparent" type="text" placeholder="link" value={url} readOnly />

                    <button className="bg-red-500 text-white rounded text-sm py-2 px-5 mr-2 xl:hover:bg-red-600">
                        Copy
                    </button>
                </div>
            </div>
