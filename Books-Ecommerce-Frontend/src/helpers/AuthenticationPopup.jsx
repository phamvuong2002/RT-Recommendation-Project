...
export const AuthenticationPopup = ({ open, setOpen, emailInput, phoneInput, icon, authenStatus, setAuthenStatus, nextStep, handleError }) => {    // const handleAuthenEmail = async (user) => {
